...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    public final Map f52857a;

    /* JADX INFO: renamed from: b */
    public final KotlinTypeChecker.TypeConstructorEquality f52858b;

    /* JADX INFO: renamed from: c */
    public final KotlinTypeRefiner f52859c;

    /* JADX INFO: renamed from: d */
    public final KotlinTypePreparator f52860d;

    /* JADX INFO: renamed from: e */
    public final InterfaceC1439n f52861e;

    public OverridingUtilTypeSystemContext(Map<TypeConstructor, ? extends TypeConstructor> map, KotlinTypeChecker.TypeConstructorEquality equalityAxioms, KotlinTypeRefiner kotlinTypeRefiner, KotlinTypePreparator kotlinTypePreparator, InterfaceC1439n interfaceC1439n) {
        AbstractC16544l.m18094g(equalityAxioms, "equalityAxioms");
        ...
        this.f52857a = map;
        this.f52858b = equalityAxioms;
        this.f52859c = kotlinTypeRefiner;
        this.f52860d = kotlinTypePreparator;
        this.f52861e = interfaceC1439n;
    }
    ...
    public boolean areEqualTypeConstructors(TypeConstructorMarker c9, TypeConstructorMarker c10) {
        ...
        if (!ClassicTypeSystemContext.DefaultImpls.areEqualTypeConstructors(this, c9, c10)) {
            TypeConstructor typeConstructor = (TypeConstructor) c9;
            TypeConstructor typeConstructor2 = (TypeConstructor) c10;
            if (!this.f52858b.equals(typeConstructor, typeConstructor2)) {
                Map map = this.f52857a;
                if (map != null) {
    ...
    public CapturedTypeMarker asCapturedTypeUnwrappingDnn(RigidTypeMarker rigidTypeMarker) {
        AbstractC16544l.m18094g(rigidTypeMarker, "<this>");
    ...
    public TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int i10) {
        AbstractC16544l.m18094g(typeArgumentListMarker, "<this>");
        ...
        if (typeArgumentListMarker instanceof ArgumentList) {
            ...
            AbstractC16544l.m18093f(typeArgumentMarker, "get(...)");
            return typeArgumentMarker;
        }
        throw new IllegalStateException(("unknown type argument list type: " + typeArgumentListMarker + ", " + AbstractC16526C.f51263a.mo5693b(typeArgumentListMarker.getClass())).toString());
    }
    ...
    public boolean isFlexibleWithDifferentTypeConstructors(KotlinTypeMarker kotlinTypeMarker) {
        AbstractC16544l.m18094g(kotlinTypeMarker, "<this>");
        return !AbstractC16544l.m18089b(typeConstructor(lowerBoundIfFlexible(kotlinTypeMarker)), typeConstructor(upperBoundIfFlexible(kotlinTypeMarker)));
    }
    ...
    public RigidTypeMarker lowerBoundIfFlexible(KotlinTypeMarker kotlinTypeMarker) {
        ...
        RigidTypeMarker rigidTypeMarkerAsRigidType = asRigidType(kotlinTypeMarker);
        AbstractC16544l.m18091d(rigidTypeMarkerAsRigidType);
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public KotlinTypeMarker makeDefinitelyNotNullOrNotNull(KotlinTypeMarker kotlinTypeMarker, boolean z6) {
        return ClassicTypeSystemContext.DefaultImpls.makeDefinitelyNotNullOrNotNull(this, kotlinTypeMarker, z6);
    }
    ...
    public TypeCheckerState newTypeCheckerState(boolean z6, boolean z10) {
        if (this.f52861e != null) {
            return new TypeCheckerState(z6, z10, this, this.f52860d, this.f52859c) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilTypeSystemContext.newTypeCheckerState.1

                /* JADX INFO: renamed from: j */
                public final /* synthetic */ OverridingUtilTypeSystemContext f52862j;
                ...
                public boolean customIsSubtypeOf(KotlinTypeMarker subType, KotlinTypeMarker superType) {
                    ...
                    if (superType instanceof KotlinType) {
                        return ((Boolean) this.f52862j.f52861e.invoke(subType, superType)).booleanValue();
                    }
                    throw new IllegalArgumentException("Failed requirement.");
                }
            };
        }
        return ClassicTypeCheckerStateKt.createClassicTypeCheckerState(z6, z10, this, this.f52860d, this.f52859c);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public KotlinTypeMarker withNullability(KotlinTypeMarker kotlinTypeMarker, boolean z6) {
        return ClassicTypeSystemContext.DefaultImpls.withNullability(this, kotlinTypeMarker, z6);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public SimpleTypeMarker withNullability(RigidTypeMarker rigidTypeMarker, boolean z6) {
        return ClassicTypeSystemContext.DefaultImpls.withNullability((ClassicTypeSystemContext) this, rigidTypeMarker, z6);
    }
}
