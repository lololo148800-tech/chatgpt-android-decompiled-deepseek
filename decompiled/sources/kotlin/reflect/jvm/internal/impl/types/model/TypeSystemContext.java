...
public interface TypeSystemContext extends TypeSystemOptimizationContext {
    ...
    TypeArgumentMarker getArgumentOrNull(RigidTypeMarker rigidTypeMarker, int i10);
    ...
    KotlinTypeMarker makeDefinitelyNotNullOrNotNull(KotlinTypeMarker kotlinTypeMarker, boolean z6);
    ...
    KotlinTypeMarker withNullability(KotlinTypeMarker kotlinTypeMarker, boolean z6);

    RigidTypeMarker withNullability(RigidTypeMarker rigidTypeMarker, boolean z6);
}
