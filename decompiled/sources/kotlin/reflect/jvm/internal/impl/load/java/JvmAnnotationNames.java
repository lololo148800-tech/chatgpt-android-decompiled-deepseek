...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        METADATA_DESC = TokenNames.f32014L + JvmClassName.byFqNameWithoutInnerClasses(fqName).getInternalName() + Separators.SEMICOLON;
        ...
        SERIALIZED_IR_DESC = TokenNames.f32014L + JvmClassName.byFqNameWithoutInnerClasses(fqName2).getInternalName() + Separators.SEMICOLON;
