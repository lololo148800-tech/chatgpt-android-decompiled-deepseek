...
public abstract class AbstractC9411e extends AbstractCollection implements Serializable, Collection {

    /* JADX INFO: renamed from: Y */
    public static final Object[] f28382Y = new Object[0];
    ...
    public abstract int mo9988f(Object[] objArr);
    ...
    public abstract int mo9989i();

    /* JADX INFO: renamed from: j */
    public abstract int mo9990j();

    /* JADX INFO: renamed from: m */
    public abstract Object[] mo9991m();
    ...
    public final Object[] toArray(Object[] objArr) {
        ...
        if (length < size) {
            Object[] objArrMo9991m = mo9991m();
            if (objArrMo9991m == null) {
                if (length != 0) {
                    objArr = Arrays.copyOf(objArr, 0);
                }
                objArr = Arrays.copyOf(objArr, size);
            } else {
                return Arrays.copyOfRange(objArrMo9991m, mo9990j(), mo9989i(), objArr.getClass());
            }
        } else if (length > size) {
            objArr[size] = null;
        }
