...
public final class C13623h extends AbstractC19694j implements InterfaceC1439n {

    /* JADX INFO: renamed from: Y */
    public int f43038Y;

    /* JADX INFO: renamed from: Z */
    public final /* synthetic */ Context f43039Z;

    /* JADX INFO: renamed from: o0 */
    public final /* synthetic */ C13625j f43040o0;

    /* JADX INFO: renamed from: p0 */
    public final /* synthetic */ InterfaceC0832p f43041p0;

    /* JADX INFO: renamed from: q0 */
    public final /* synthetic */ Uri f43042q0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13623h(Context context, C13625j c13625j, InterfaceC0832p interfaceC0832p, Uri uri, InterfaceC18770c interfaceC18770c) {
        super(2, interfaceC18770c);
        this.f43039Z = context;
        this.f43040o0 = c13625j;
        this.f43041p0 = interfaceC0832p;
        this.f43042q0 = uri;
    }

    @Override // sm.AbstractC19685a
    public final InterfaceC18770c create(Object obj, InterfaceC18770c interfaceC18770c) {
        return new C13623h(this.f43039Z, this.f43040o0, this.f43041p0, this.f43042q0, interfaceC18770c);
    }

    @Override // p049Bm.InterfaceC1439n
    public final Object invoke(Object obj, Object obj2) {
        return ((C13623h) create((InterfaceC0571F) obj, (InterfaceC18770c) obj2)).invokeSuspend(C17296C.f55119a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i10 = this.f43038Y;
        C13625j c13625j = this.f43040o0;
        Context context = this.f43039Z;
        if (i10 == 0) {
            ...
            this.f43038Y = 1;
            obj = ((C0840x) this.f43041p0).m1898b(c6354gM6972a, this);
            if (obj == enumC19250a) {
                return enumC19250a;
            }
        } else {
        ...
        if (z6) {
            ...
            AbstractC16544l.m18093f(bitmapCopy, "copy(...)");
            c21945n1 = AbstractC7886F5.m8181d(c13625j, context, c13616aM8180c, outputFile, bitmapCopy, AbstractC14334L.m15617F(((C14365u) c13625j.f43054g.getValue()).f45062a), Bitmap.CompressFormat.JPEG);
        } else {
