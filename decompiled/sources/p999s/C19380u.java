...
public class C19380u extends ImageButton {

    /* JADX INFO: renamed from: o0 */
    public final C1904b f61390o0;

    /* JADX INFO: renamed from: p0 */
    public final C0420b f61391p0;

    /* JADX INFO: renamed from: q0 */
    public boolean f61392q0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C19380u(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        AbstractC19313P0.m20399a(context);
        this.f61392q0 = false;
        AbstractC19311O0.m20394a(this, getContext());
        C1904b c1904b = new C1904b(this);
        this.f61390o0 = c1904b;
        c1904b.m3003k(attributeSet, i10);
        C0420b c0420b = new C0420b(this);
        this.f61391p0 = c0420b;
    ...
    public final void drawableStateChanged() {
        ...
        C1904b c1904b = this.f61390o0;
        if (c1904b != null) {
            c1904b.m2993a();
        }
        C0420b c0420b = this.f61391p0;
        if (c0420b != null) {
            c0420b.m1048c();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f61391p0.f1382o0).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C0420b c0420b = this.f61391p0;
        if (c0420b != null && drawable != null && !this.f61392q0) {
