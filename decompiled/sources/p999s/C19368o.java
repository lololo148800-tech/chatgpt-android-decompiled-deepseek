...
public class C19368o extends CheckBox implements InterfaceC2258q, InterfaceC2259r {

    /* JADX INFO: renamed from: o0 */
    public final C3231f f61332o0;

    /* JADX INFO: renamed from: p0 */
    public final C1904b f61333p0;

    /* JADX INFO: renamed from: q0 */
    public final C19321U f61334q0;

    /* JADX INFO: renamed from: r0 */
    public C19378t f61335r0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C19368o(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        AbstractC19313P0.m20399a(context);
        AbstractC19311O0.m20394a(this, getContext());
        C3231f c3231f = new C3231f(this);
        this.f61332o0 = c3231f;
        c3231f.m4124e(attributeSet, i10);
        C1904b c1904b = new C1904b(this);
        this.f61333p0 = c1904b;
        c1904b.m3003k(attributeSet, i10);
        C19321U c19321u = new C19321U(this);
        this.f61334q0 = c19321u;
        c19321u.m20416f(attributeSet, i10);
        getEmojiTextViewHelper().m20479a(attributeSet, i10);
    }

    private C19378t getEmojiTextViewHelper() {
        if (this.f61335r0 == null) {
            this.f61335r0 = new C19378t(this);
        }
        return this.f61335r0;
    }

    @Override // android.widget.CompoundButton, android.widget.TextView, android.view.View
    public void drawableStateChanged() {
        super.drawableStateChanged();
        C1904b c1904b = this.f61333p0;
        if (c1904b != null) {
            c1904b.m2993a();
        }
        C19321U c19321u = this.f61334q0;
        if (c19321u != null) {
            c19321u.m20413b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f61334q0.m20414d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f61334q0.m20415e();
    }
