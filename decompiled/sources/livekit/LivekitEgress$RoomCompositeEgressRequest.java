...
import p793ho.EnumC14589H0;
import p793ho.EnumC14595I0;
...
public final class LivekitEgress$RoomCompositeEgressRequest extends AbstractC12133Z implements InterfaceC12094H0 {
    ...
    static {
        ...
        AbstractC12133Z.registerDefaultInstance(LivekitEgress$RoomCompositeEgressRequest.class, livekitEgress$RoomCompositeEgressRequest);
    }
    ...
    public static C14583G0 newBuilder() {
        return (C14583G0) DEFAULT_INSTANCE.createBuilder();
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseDelimitedFrom(InputStream inputStream) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(ByteBuffer byteBuffer) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setCustomBaseUrlBytes(AbstractC12171m abstractC12171m) {
        AbstractC12138b.checkByteStringIsUtf8(abstractC12171m);
        this.customBaseUrl_ = abstractC12171m.m14012w();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setVideoOnly(boolean z6) {
        this.videoOnly_ = z6;
    }
    ...
    public AbstractC12171m getCustomBaseUrlBytes() {
        return AbstractC12171m.m14011m(this.customBaseUrl_);
    }
    ...
    public EnumC14589H0 getOptionsCase() {
        int i10 = this.optionsCase_;
        if (i10 == 0) {
            return EnumC14589H0.f45850o0;
        }
        if (i10 == 8) {
            return EnumC14589H0.f45848Y;
        }
        if (i10 != 9) {
            return null;
        }
        return EnumC14589H0.f45849Z;
    }

    public EnumC14595I0 getOutputCase() {
        int i10 = this.outputCase_;
        if (i10 == 0) {
            return EnumC14595I0.f45861p0;
        }
        if (i10 == 10) {
            return EnumC14595I0.f45860o0;
        }
        if (i10 == 6) {
            return EnumC14595I0.f45858Y;
        }
        if (i10 != 7) {
            return null;
        }
        return EnumC14595I0.f45859Z;
    }
    ...
    public static C14583G0 newBuilder(LivekitEgress$RoomCompositeEgressRequest livekitEgress$RoomCompositeEgressRequest) {
        return (C14583G0) DEFAULT_INSTANCE.createBuilder(livekitEgress$RoomCompositeEgressRequest);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseDelimitedFrom(InputStream inputStream, C12087F c12087f) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c12087f);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(ByteBuffer byteBuffer, C12087F c12087f) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, byteBuffer, c12087f);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(AbstractC12171m abstractC12171m) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12171m);
    }
    ...
    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(AbstractC12171m abstractC12171m, C12087F c12087f) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12171m, c12087f);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(byte[] bArr) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(byte[] bArr, C12087F c12087f) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, bArr, c12087f);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(InputStream inputStream) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(InputStream inputStream, C12087F c12087f) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, inputStream, c12087f);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(AbstractC12186r abstractC12186r) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12186r);
    }

    public static LivekitEgress$RoomCompositeEgressRequest parseFrom(AbstractC12186r abstractC12186r, C12087F c12087f) {
        return (LivekitEgress$RoomCompositeEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12186r, c12087f);
    }
}
