...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private CameraCharacteristics getCameraCharacteristics(String str) {
        try {
            ...
            Logging.m18744e(TAG, "Camera access exception", e10);
            return null;
        }
    }
    ...
    public static boolean isSupported(Context context) {
        ...
        try {
            ...
            Logging.m18744e(TAG, "Failed to check if camera2 is supported", e10);
            return false;
        }
    }
    ...
    public String[] getDeviceNames() {
        try {
            ...
            Logging.m18744e(CsqksqyPE.ilmCn, "Camera access exception", e10);
            return new String[0];
        }
    }
        ...
        synchronized (map) {
            try {
                if (!map.containsKey(str)) {
                    Logging.m18742d(TAG, "Get supported formats for camera index " + str + Separators.DOT);
                    ...
                    try {
                        ...
                        for (Size size : supportedSizes) {
                            ...
                            Logging.m18742d(TAG, "Format: " + size.width + "x" + size.height + Separators.f31989AT + iRound);
                        }
                        cachedSupportedFormats.put(str, arrayList);
                        Logging.m18742d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                        return arrayList;
                    } catch (Exception e10) {
                        Logging.m18744e(TAG, "getCameraCharacteristics()", e10);
