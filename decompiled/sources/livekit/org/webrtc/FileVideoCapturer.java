...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private final TimerTask tickTask = new TimerTask() { // from class: livekit.org.webrtc.FileVideoCapturer.1
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i10 == -1) {
                    throw new RuntimeException(AbstractC9306j0.m9889h("Found end of file before end of header for file: ", str));
                }
                if (i10 == 10) {
                    ...
                    Logging.m18742d(TAG, "Color space: " + strSubstring);
                    ...
                    Logging.m18742d(TAG, AbstractC0168G.m532u("frame dim: (", i11, ", ", i12, Separators.RPAREN));
                    return;
                }
                sb2.append((char) i10);
            }
        ...
        @Override // livekit.org.webrtc.FileVideoCapturer.VideoReader
        public void close() {
            try {
                this.mediaFile.close();
            } catch (IOException e10) {
                Logging.m18744e(TAG, "Problem closing file", e10);
            }
        }
        ...
        public VideoFrame getNextFrame() {
            ...
            try {
                ...
                throw new RuntimeException("Frames should be delimited by FRAME plus newline, found delimter was: '" + str + Separators.QUOTE);
            } catch (IOException e10) {
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m18742d(TAG, "Could not open video file: " + str);
            throw e10;
        }
    }
