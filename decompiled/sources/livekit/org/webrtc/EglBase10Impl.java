...
public class EglBase10Impl implements EglBase10 {
    ...
    public static class EglConnection implements EglBase10.EglConnection {
        ...
        public /* synthetic */ EglConnection(int i10) {
            this();
        }
        ...
        @Override // livekit.org.webrtc.EglBase10.EglConnection
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            int iM18871l = AbstractC17039i.m18871l(iArr);
            Logging.m18742d(EglBase10Impl.TAG, "Using OpenGL ES version " + iM18871l);
            this.eglContext = EglBase10Impl.createEglContext(egl10, eGLContext, eglDisplay, eglConfig, iM18871l);
            this.refCountDelegate = new RefCountDelegate(new RunnableC17041k(this, 0));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new RunnableC0068j(6));
        }
    }
    ...
    public static EGLContext createEglContext(EGL10 egl10, EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i10) {
        ...
        throw new GLException(egl10.eglGetError(), AbstractC9306j0.m9889h("Failed to create EGL context: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        if (eGLSurfaceEglCreateWindowSurface == eGLSurface2) {
            throw new GLException(egl.eglGetError(), AbstractC9306j0.m9889h("Failed to create window surface: 0x", Integer.toHexString(egl.eglGetError())));
        }
    }
    ...
    public static EGLConfig getEglConfig(EGL10 egl10, EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!egl10.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            throw new GLException(egl10.eglGetError(), AbstractC9306j0.m9889h("eglChooseConfig failed: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (iArr2[0] <= 0) {
    ...
    public static EGLDisplay getEglDisplay(EGL10 egl10) {
        ...
        if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            throw new GLException(egl10.eglGetError(), AbstractC9306j0.m9889h("Unable to get EGL10 display: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (egl10.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GLException(egl10.eglGetError(), AbstractC9306j0.m9889h("Unable to initialize EGL10: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    public void createPbufferSurface(int i10, int i11) {
        ...
        StringBuilder sbM21e = AbstractC0010F.m21e("Failed to create pixel buffer surface with size ", i10, "x", i11, ": 0x");
        sbM21e.append(hexString);
        throw new GLException(iEglGetError, sbM21e.toString());
    }
