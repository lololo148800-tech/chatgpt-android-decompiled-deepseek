...
public class RendererCommon {
    ...
    /* JADX INFO: renamed from: livekit.org.webrtc.RendererCommon$1 */
    public static /* synthetic */ class C170121 {
    ...
    public static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i10 = C170121.$SwitchMap$org$webrtc$RendererCommon$ScalingType[scalingType.ordinal()];
        if (i10 == 1) {
            return 1.0f;
        }
        if (i10 == 2) {
    ...
    public static float[] getLayoutMatrix(boolean z6, float f10, float f11) {
        float f12;
        float f13;
        if (f11 > f10) {
            f13 = f10 / f11;
