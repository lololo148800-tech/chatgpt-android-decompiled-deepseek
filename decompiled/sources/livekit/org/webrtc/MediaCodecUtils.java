...
class MediaCodecUtils {
    ...
    /* JADX INFO: renamed from: livekit.org.webrtc.MediaCodecUtils$1 */
    public static /* synthetic */ class C170051 {
    ...
    public static Map<String, String> getCodecProperties(VideoCodecMimeType videoCodecMimeType, boolean z6) {
        int i10 = C170051.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];
        if (i10 == 1 || i10 == 2 || i10 == 3 || i10 == 4) {
            return new HashMap();
        }
        if (i10 == 5) {
            return H264Utils.getDefaultH264Params(z6);
        }
