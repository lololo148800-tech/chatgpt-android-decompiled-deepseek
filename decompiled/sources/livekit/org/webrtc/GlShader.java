...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (iGlCreateProgram == 0) {
            throw new RuntimeException(AbstractC10763a.m11048f(GLES20.glGetError(), "glCreateProgram() failed. GLES20 error: "));
        }
        ...
        if (iArr[0] == 1) {
            ...
            Logging.m18743e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    private static int compileShader(int i10, String str) {
        ...
        if (iGlCreateShader == 0) {
            throw new RuntimeException(AbstractC10763a.m11048f(GLES20.glGetError(), "glCreateShader() failed. GLES20 error: "));
        }
        ...
        Logging.m18743e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(iGlCreateShader) + " in shader:\n" + str);
    ...
    public int getAttribLocation(String str) {
        ...
        throw new RuntimeException(AbstractC10763a.m11054l("Could not locate '", str, "' in program"));
    }
    ...
    public int getUniformLocation(String str) {
        ...
        throw new RuntimeException(AbstractC10763a.m11054l("Could not locate uniform '", str, "' in program"));
    }

    public void release() {
        Logging.m18742d(TAG, "Deleting shader.");
        int i10 = this.program;
        if (i10 != -1) {
