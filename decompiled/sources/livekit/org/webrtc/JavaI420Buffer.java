...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i10, int i11) {
        ...
        return new JavaI420Buffer(i10, i11, byteBufferSlice, i10, byteBufferSlice2, i13, byteBufferNativeAllocateByteBuffer.slice(), i13, new RunnableC17048r(0, byteBufferNativeAllocateByteBuffer));
    }
    ...
    private static void checkCapacity(ByteBuffer byteBuffer, int i10, int i11, int i12) {
        ...
        if (byteBuffer.capacity() < i13) {
            throw new IllegalArgumentException(AbstractC17792x.m19534q("Buffer must be at least ", i13, byteBuffer.capacity(), " bytes, but was "));
        }
    }
    ...
    public static VideoFrame.Buffer cropAndScaleI420(VideoFrame.I420Buffer i420Buffer, int i10, int i11, int i12, int i13, int i14, int i15) {
        ...
        int i17 = i11 / 2;
        i420Buffer.retain();
        return wrap(i14, i15, dataY.slice(), i420Buffer.getStrideY(), dataU.slice(), i420Buffer.getStrideU(), dataV.slice(), i420Buffer.getStrideV(), new RunnableC17041k(i420Buffer, 4));
    }
