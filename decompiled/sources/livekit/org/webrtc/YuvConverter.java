...
public final class YuvConverter {
    ...
    private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer textureBuffer) {
        ...
        int i11 = (height + 1) / 2;
        int i12 = height + i11;
        ByteBuffer byteBufferNativeAllocateByteBuffer = JniCommon.nativeAllocateByteBuffer(i10 * i12);
        int i13 = i10 / 4;
        ...
        return JavaI420Buffer.wrap(width, height, byteBufferSlice, i10, byteBufferSlice2, i10, byteBufferSlice3, i10, new RunnableC17048r(1, byteBufferNativeAllocateByteBuffer));
    }
    ...
    public VideoFrame.I420Buffer convert(VideoFrame.TextureBuffer textureBuffer) {
        try {
            ...
            Logging.m18747w(TAG, "Failed to convert TextureBuffer", e10);
            return null;
        }
    }
