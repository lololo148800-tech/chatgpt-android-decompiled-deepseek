...
public class NetworkMonitor {
    ...
    private boolean networkBindingSupported() {
        ...
        synchronized (this.networkChangeDetectorLock) {
            try {
                ...
                z6 = networkChangeDetector != null && networkChangeDetector.supportNetworkCallback();
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    private void stopMonitoring(long j10) {
        Logging.m18742d(TAG, "Stop monitoring with native observer " + j10);
        stopMonitoring();
        synchronized (this.nativeNetworkObservers) {
    ...
    private void startMonitoring(Context context, long j10, String str) {
        Logging.m18742d(TAG, "Start monitoring with native observer " + j10 + " fieldTrialsString: " + str);
        if (context == null) {
