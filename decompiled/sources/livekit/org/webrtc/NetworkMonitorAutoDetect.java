...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    public static class ConnectivityManagerDelegate {
        ...
        private static boolean checkFieldTrial(String str, String str2, boolean z6) {
        ...
        public NetworkChangeDetector.NetworkInformation networkToInfo(Network network) {
            ...
            if (linkProperties == null) {
                Logging.m18746w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network.toString());
                return null;
            }
            if (linkProperties.getInterfaceName() == null) {
                Logging.m18746w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network.toString());
                return null;
            }
            ...
            if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_NONE) {
                Logging.m18742d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is disconnected");
                return null;
            }
            if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN || connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                Logging.m18742d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " connection type is " + connectionType + " because it has type " + networkState.getNetworkType() + " and subtype " + networkState.getNetworkSubType());
            }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m18742d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
        ...
        public NetworkState getNetworkState(Network network) {
            ...
            if (network != null && (connectivityManager = this.connectivityManager) != null) {
                ...
                if (networkInfo == null) {
                    Logging.m18746w(NetworkMonitorAutoDetect.TAG, "Couldn't retrieve information from network " + network.toString());
    ...
    public static class NetworkState {
        ...
        public NetworkState(boolean z6, int i10, int i11, int i12, int i13) {
            this.connected = z6;
            this.type = i10;
            this.subtype = i11;
    ...
    public class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Logging.m18742d(NetworkMonitorAutoDetect.TAG, "Network handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + " becomes available: " + network.toString());
            synchronized (this.availableNetworks) {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            Logging.m18742d(NetworkMonitorAutoDetect.TAG, "handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + " capabilities changed: " + networkCapabilities.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m18742d(NetworkMonitorAutoDetect.TAG, "handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + " link properties changed");
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLosing(Network network, int i10) {
            Logging.m18742d(NetworkMonitorAutoDetect.TAG, "Network handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + ", " + network.toString() + " is about to lose in " + i10 + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            Logging.m18742d(NetworkMonitorAutoDetect.TAG, "Network handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + ", " + network.toString() + " is disconnected");
            synchronized (this.availableNetworks) {
    ...
    public static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        public WifiDirectManagerDelegate(NetworkChangeDetector.Observer observer, Context context) {
            ...
            if (Build.VERSION.SDK_INT > 28) {
                ...
                wifiP2pManager.requestGroupInfo(wifiP2pManager.initialize(context, context.getMainLooper(), null), new WifiP2pManager.GroupInfoListener() { // from class: livekit.org.webrtc.t
                    @Override // android.net.wifi.p2p.WifiP2pManager.GroupInfoListener
                    public final void onGroupInfoAvailable(WifiP2pGroup wifiP2pGroup) {
                        this.f54512a.lambda$new$0(wifiP2pGroup);
                    }
                });
            }
        }
        ...
        public void lambda$new$0(WifiP2pGroup wifiP2pGroup) {
            ...
            try {
                ...
                Logging.m18744e(NetworkMonitorAutoDetect.TAG, "Unable to get WifiP2p network interface", e10);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void onWifiP2pStateChange(int i10) {
            if (i10 == 1) {
        ...
        public void onReceive(Context context, Intent intent) {
            VMRunner.invoke("EiWIkHhR5raNALcw", new Object[]{this, context, intent});
        }
    ...
    public NetworkMonitorAutoDetect(NetworkChangeDetector.Observer observer, Context context) {
        ...
        try {
            ...
            Logging.m18746w(TAG, "Unable to obtain permission to request a cellular network.");
        }
    ...
    public void connectionTypeChanged(NetworkState networkState) {
        ...
        Logging.m18742d(TAG, "Network connectivity changed, type is: " + connectionType);
        this.observer.onConnectionTypeChanged(connectionType);
    }

    private static NetworkChangeDetector.ConnectionType getConnectionType(boolean z6, int i10, int i11) {
        if (!z6) {
    ...
    public static void setIncludeWifiDirect(boolean z6) {
        includeWifiDirect = z6;
    }
    ...
    @Override // livekit.org.webrtc.NetworkChangeDetector
    public void destroy() {
    ...
    @Override // android.content.BroadcastReceiver
    public void onReceive(Context context, Intent intent) {
        VMRunner.invoke("xYgIReWKqzWPAHkh", new Object[]{this, context, intent});
    }
