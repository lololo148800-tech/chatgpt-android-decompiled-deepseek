...
class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    private VideoFrame.Buffer copyI420Buffer(ByteBuffer byteBuffer, int i10, int i11, int i12, int i13) {
        if (i10 % 2 != 0) {
            throw new AssertionError(AbstractC10763a.m11048f(i10, "Stride is not divisible by two: "));
        }
        int i14 = (i12 + 1) / 2;
        int i15 = i11 % 2;
    ...
    private void deliverByteFrame(int i10, MediaCodec.BufferInfo bufferInfo, int i11, Integer num) {
        ...
        if (i16 < ((i12 * i13) * 3) / 2) {
            Logging.m18743e(TAG, "Insufficient output buffer size: " + i16);
            return;
        }
        ...
        VideoFrame.Buffer bufferCopyI420Buffer = this.colorFormat == 19 ? copyI420Buffer(byteBufferSlice, i17, i15, i12, i13) : copyNV12ToI420Buffer(byteBufferSlice, i17, i15, i12, i13);
        this.codec.releaseOutputBuffer(i10, false);
        VideoFrame videoFrame = new VideoFrame(bufferCopyI420Buffer, i11, bufferInfo.presentationTimeUs * 1000);
    ...
    private VideoCodecStatus initDecodeInternal(int i10, int i11) {
        ...
        Logging.m18742d(TAG, "initDecodeInternal name: " + this.codecName + " type: " + this.codecType + " width: " + i10 + " height: " + i11 + " color format: " + this.colorFormat);
        if (this.outputThread != null) {
            Logging.m18743e(TAG, "initDecodeInternal called while the codec is already running");
        ...
        try {
            ...
            try {
                ...
                Logging.m18742d(TAG, "initDecodeInternal done");
                return VideoCodecStatus.OK;
            } catch (IllegalArgumentException e10) {
                e = e10;
                Logging.m18744e(TAG, "initDecode failed", e);
                release();
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            ...
            Logging.m18743e(TAG, "Cannot create media decoder " + this.codecName);
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    private void reformat(MediaFormat mediaFormat) {
        ...
        Logging.m18742d(TAG, "Decoder format changed: " + mediaFormat);
            ...
            try {
                ...
                if (integer != i10 || integer2 != this.height) {
                    if (this.hasDecodedFirstFrame) {
                        stopOnOutputThread(new RuntimeException("Unexpected size change. Configured " + this.width + Separators.STAR + this.height + ". New " + integer + Separators.STAR + integer2));
                        return;
                    }
                    ...
                    Logging.m18746w(TAG, "Unexpected format dimensions. Configured " + i10 + Separators.STAR + this.height + ". New " + integer + Separators.STAR + integer2 + ". Skip it");
                    return;
                }
                if (this.surfaceTextureHelper == null && mediaFormat.containsKey("color-format")) {
                    int integer3 = mediaFormat.getInteger("color-format");
                    this.colorFormat = integer3;
                    Logging.m18742d(TAG, "Color: 0x" + Integer.toHexString(integer3));
                    if (!isSupportedColorFormat(this.colorFormat)) {
                        stopOnOutputThread(new IllegalStateException(AbstractC10763a.m11048f(this.colorFormat, "Unsupported color format: ")));
                        return;
                    }
                }
                synchronized (this.dimensionLock) {
                    try {
                        ...
                        Logging.m18742d(TAG, "Frame stride and slice height: " + this.stride + " x " + this.sliceHeight);
    ...
    public void releaseCodecOnOutputThread() {
        ...
        try {
            ...
            Logging.m18744e(TAG, "Media decoder stop failed", e10);
        }
        try {
            this.codec.release();
        } catch (Exception e11) {
            Logging.m18744e(TAG, "Media decoder release failed", e11);
    ...
    private VideoCodecStatus releaseInternal() {
        if (!this.running) {
            Logging.m18742d(TAG, "release: Decoder is not running.");
            return VideoCodecStatus.OK;
        }
        try {
            this.running = false;
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, 5000L)) {
                Logging.m18744e(TAG, "Media decoder release timeout", new RuntimeException());
            ...
            Logging.m18744e(TAG, "Media decoder release error", new RuntimeException(this.shutdownException));
    ...
    public final /* synthetic */ long createNative(long j10) {
        return AbstractC16971B.m18600a(this, j10);
    }
    ...
    public VideoCodecStatus decode(EncodedImage encodedImage, VideoDecoder.DecodeInfo decodeInfo) {
        ...
        if (mediaCodecWrapper == null || this.callback == null) {
            boolean z6 = mediaCodecWrapper != null;
            Logging.m18742d(TAG, "decode uninitalized, codec: " + z6 + ", callback: " + this.callback);
            return VideoCodecStatus.UNINITIALIZED;
        }
        ByteBuffer byteBuffer = encodedImage.buffer;
        if (byteBuffer == null) {
            Logging.m18743e(TAG, "decode() - no input data");
            return VideoCodecStatus.ERR_PARAMETER;
        }
        int iRemaining = byteBuffer.remaining();
        if (iRemaining == 0) {
            Logging.m18743e(TAG, "decode() - input buffer empty");
            return VideoCodecStatus.ERR_PARAMETER;
        }
        synchronized (this.dimensionLock) {
            i10 = this.width;
    ...
    public void deliverDecodedFrame() {
        ...
        try {
            ...
            if (iDequeueOutputBuffer < 0) {
                Logging.m18745v(TAG, "dequeueOutputBuffer returned " + iDequeueOutputBuffer);
                return;
            }
            ...
            Logging.m18744e(TAG, "deliverDecodedFrame failed", e10);
        }
    }
    ...
    public AndroidVideoDecoder(MediaCodecWrapperFactory mediaCodecWrapperFactory, String str, VideoCodecMimeType videoCodecMimeType, int i10, EglBase.Context context) {
        if (isSupportedColorFormat(i10)) {
            Logging.m18742d(MpoABj.uVioq, "ctor name: " + str + " type: " + videoCodecMimeType + " color format: " + i10 + " context: " + context);
        ...
        throw new IllegalArgumentException(AbstractC10763a.m11048f(i10, "Unsupported color format: "));
    }
}
