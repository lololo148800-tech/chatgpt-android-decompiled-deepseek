...
public class PeerConnectionFactory {
    ...
    public static class InitializationOptions {
        ...
        public /* synthetic */ InitializationOptions(Context context, String str, boolean z6, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity, int i10) {
            this(context, str, z6, nativeLibraryLoader, str2, loggable, severity);
        }
        ...
        private InitializationOptions(Context context, String str, boolean z6, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity) {
            this.applicationContext = context;
            this.fieldTrials = str;
            this.enableInternalTracer = z6;
            this.nativeLibraryLoader = nativeLibraryLoader;
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        if (loggable != null) {
            ...
            Logging.m18742d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static native long nativeCreateVideoSource(long j10, boolean z6, boolean z10);
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m18742d(TAG, "onNetworkThreadReady");
    }

    private void onSignalingThreadReady() {
        this.signalingThread = ThreadInfo.getCurrent();
        staticSignalingThread = this.signalingThread;
        Logging.m18742d(TAG, "onSignalingThreadReady");
    }

    private void onWorkerThreadReady() {
        this.workerThread = ThreadInfo.getCurrent();
        staticWorkerThread = this.workerThread;
        Logging.m18742d(TAG, "onWorkerThreadReady");
    }

    private static void printStackTrace(ThreadInfo threadInfo, boolean z6) {
        if (threadInfo == null) {
            return;
        }
        ...
        if (stackTrace.length > 0) {
            Logging.m18746w(TAG, name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m18746w(TAG, stackTraceElement.toString());
            }
        }
        if (z6) {
            Logging.m18746w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            StringBuilder sbM21e = AbstractC0010F.m21e("pid: ", Process.myPid(), ", tid: ", threadInfo.tid, ", name: ");
            sbM21e.append(name);
            sbM21e.append("  >>> WebRTC <<<");
            Logging.m18746w(TAG, sbM21e.toString());
    ...
    public VideoSource createVideoSource(boolean z6, boolean z10) {
        checkPeerConnectionFactoryExists();
        return new VideoSource(nativeCreateVideoSource(this.nativeFactory, z6, z10));
    }
    ...
    public VideoSource createVideoSource(boolean z6) {
        return createVideoSource(z6, true);
    }
