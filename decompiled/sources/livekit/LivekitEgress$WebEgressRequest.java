...
import p793ho.EnumC14759i1;
import p793ho.EnumC14766j1;
...
public final class LivekitEgress$WebEgressRequest extends AbstractC12133Z implements InterfaceC12094H0 {
    ...
    static {
        ...
        AbstractC12133Z.registerDefaultInstance(LivekitEgress$WebEgressRequest.class, livekitEgress$WebEgressRequest);
    }
    ...
    public static C14752h1 newBuilder() {
        return (C14752h1) DEFAULT_INSTANCE.createBuilder();
    }

    public static LivekitEgress$WebEgressRequest parseDelimitedFrom(InputStream inputStream) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(ByteBuffer byteBuffer) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setAwaitStartSignal(boolean z6) {
        this.awaitStartSignal_ = z6;
    }
    ...
    public EnumC14759i1 getOptionsCase() {
        int i10 = this.optionsCase_;
        if (i10 == 0) {
            return EnumC14759i1.f46160o0;
        }
        if (i10 == 7) {
            return EnumC14759i1.f46158Y;
        }
        if (i10 != 8) {
            return null;
        }
        return EnumC14759i1.f46159Z;
    }

    public EnumC14766j1 getOutputCase() {
        int i10 = this.outputCase_;
        if (i10 == 0) {
            return EnumC14766j1.f46193p0;
        }
        if (i10 == 4) {
            return EnumC14766j1.f46190Y;
        }
        if (i10 == 5) {
            return EnumC14766j1.f46191Z;
        }
        if (i10 != 6) {
            return null;
        }
        return EnumC14766j1.f46192o0;
    }
    ...
    public static C14752h1 newBuilder(LivekitEgress$WebEgressRequest livekitEgress$WebEgressRequest) {
        return (C14752h1) DEFAULT_INSTANCE.createBuilder(livekitEgress$WebEgressRequest);
    }

    public static LivekitEgress$WebEgressRequest parseDelimitedFrom(InputStream inputStream, C12087F c12087f) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c12087f);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(ByteBuffer byteBuffer, C12087F c12087f) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, byteBuffer, c12087f);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(AbstractC12171m abstractC12171m) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12171m);
    }
    ...
    public static LivekitEgress$WebEgressRequest parseFrom(AbstractC12171m abstractC12171m, C12087F c12087f) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12171m, c12087f);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(byte[] bArr) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(byte[] bArr, C12087F c12087f) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, bArr, c12087f);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(InputStream inputStream) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(InputStream inputStream, C12087F c12087f) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, inputStream, c12087f);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(AbstractC12186r abstractC12186r) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12186r);
    }

    public static LivekitEgress$WebEgressRequest parseFrom(AbstractC12186r abstractC12186r, C12087F c12087f) {
        return (LivekitEgress$WebEgressRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12186r, c12087f);
    }
}
