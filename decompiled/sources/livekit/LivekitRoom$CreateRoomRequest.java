...
public final class LivekitRoom$CreateRoomRequest extends AbstractC12133Z implements InterfaceC12094H0 {
    ...
    static {
        ...
        AbstractC12133Z.registerDefaultInstance(LivekitRoom$CreateRoomRequest.class, livekitRoom$CreateRoomRequest);
    }
    ...
    public static C14768j3 newBuilder() {
        return (C14768j3) DEFAULT_INSTANCE.createBuilder();
    }

    public static LivekitRoom$CreateRoomRequest parseDelimitedFrom(InputStream inputStream) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(ByteBuffer byteBuffer) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setConfigNameBytes(AbstractC12171m abstractC12171m) {
        AbstractC12138b.checkByteStringIsUtf8(abstractC12171m);
        this.configName_ = abstractC12171m.m14012w();
    }
    ...
    public final Object dynamicMethod(EnumC12131Y enumC12131Y, Object obj, Object obj2) {
        switch (enumC12131Y.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return AbstractC12133Z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\r\u0000\u0000\u0001\r\r\u0000\u0000\u0000\u0001Ȉ\u0002\u000b\u0003\u000b\u0004Ȉ\u0005Ȉ\u0006\t\u0007\u000b\b\u000b\t\u0007\n\u000b\u000b\t\fȈ\r\u0007", new Object[]{"name_", SfpOlmlMATQ.AqcL, "maxParticipants_", "nodeId_", "metadata_", "egress_", "minPlayoutDelay_", "maxPlayoutDelay_", "syncStreams_", "departureTimeout_", "agent_", "configName_", qffLJgOYizGmMj.nbEwrpZMvxQS});
            case 3:
                return new LivekitRoom$CreateRoomRequest();
            case 4:
                return new C14768j3(DEFAULT_INSTANCE);
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
    ...
    public AbstractC12171m getConfigNameBytes() {
        return AbstractC12171m.m14011m(this.configName_);
    }
    ...
    public static C14768j3 newBuilder(LivekitRoom$CreateRoomRequest livekitRoom$CreateRoomRequest) {
        return (C14768j3) DEFAULT_INSTANCE.createBuilder(livekitRoom$CreateRoomRequest);
    }

    public static LivekitRoom$CreateRoomRequest parseDelimitedFrom(InputStream inputStream, C12087F c12087f) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c12087f);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(ByteBuffer byteBuffer, C12087F c12087f) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, byteBuffer, c12087f);
    }

    private LivekitRoom$CreateRoomRequest() {
        String str = YladLSetV.uOIKRuVSwVFm;
        this.name_ = str;
        this.configName_ = str;
        this.nodeId_ = str;
        this.metadata_ = str;
    ...
    public static LivekitRoom$CreateRoomRequest parseFrom(AbstractC12171m abstractC12171m) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12171m);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(AbstractC12171m abstractC12171m, C12087F c12087f) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12171m, c12087f);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(byte[] bArr) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(byte[] bArr, C12087F c12087f) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, bArr, c12087f);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(InputStream inputStream) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(InputStream inputStream, C12087F c12087f) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, inputStream, c12087f);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(AbstractC12186r abstractC12186r) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12186r);
    }

    public static LivekitRoom$CreateRoomRequest parseFrom(AbstractC12186r abstractC12186r, C12087F c12087f) {
        return (LivekitRoom$CreateRoomRequest) AbstractC12133Z.parseFrom(DEFAULT_INSTANCE, abstractC12186r, c12087f);
    }
}
