...
public interface Map<K, V> {
    ...
    V merge(K k8, V v2, BiFunction<? super V, ? super V, ? extends V> biFunction);

    V putIfAbsent(K k8, V v2);

    boolean remove(Object obj, Object obj2);

    V replace(K k8, V v2);

    boolean replace(K k8, V v2, V v10);
    ...
    public final /* synthetic */ class EL {
        public static /* synthetic */ void forEach(java.util.Map map, BiConsumer biConsumer) {
            if (map instanceof Map) {
                ...
                AbstractC15702u.m17332a((ConcurrentMap) map, biConsumer);
            } else {
        ...
        public static Object m17248a(java.util.Map map, Object obj, Object obj2) {
            if (map instanceof Map) {
