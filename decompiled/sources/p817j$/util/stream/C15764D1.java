...
final class C15764D1 implements InterfaceC15848U1, InterfaceC15945l2 {

    /* JADX INFO: renamed from: a */
    private double f49049a;

    /* JADX INFO: renamed from: b */
    final /* synthetic */ double f49050b;

    /* JADX INFO: renamed from: c */
    final /* synthetic */ DoubleBinaryOperator f49051c;
    ...
    C15764D1(double d10, DoubleBinaryOperator doubleBinaryOperator) {
        this.f49050b = d10;
        this.f49051c = doubleBinaryOperator;
    }

    @Override // p817j$.util.stream.InterfaceC15848U1
    /* JADX INFO: renamed from: g */
    public final void mo17361g(InterfaceC15848U1 interfaceC15848U1) {
        accept(((C15764D1) interfaceC15848U1).f49049a);
    }

    @Override // p817j$.util.stream.InterfaceC15963o2
    /* JADX INFO: renamed from: l */
    public final void mo17364l(long j10) {
        this.f49049a = this.f49050b;
    }

    @Override // p817j$.util.stream.InterfaceC15963o2
    public final void accept(double d10) {
        this.f49049a = this.f49051c.applyAsDouble(this.f49049a, d10);
    }

    @Override // java.util.function.Supplier
    public final Object get() {
        return Double.valueOf(this.f49049a);
    }
}
