...
public final class C15541F extends AbstractC15545a implements Serializable {

    /* JADX INFO: renamed from: d */
    public static final C15541F f48552d = new C15541F();
    ...
    public final InterfaceC15556l mo16920N(int i10) {
        if (i10 == 0) {
            return EnumC15544I.BEFORE_BE;
        }
        if (i10 == 1) {
            return EnumC15544I.f48555BE;
        }
    ...
    public final ChronoLocalDate mo16914D(int i10, int i11, int i12) {
        return new C15543H(LocalDate.m16800of(i10 - 543, i11, i12));
    }

    @Override // p817j$.time.chrono.InterfaceC15555k
    /* JADX INFO: renamed from: v */
    public final ChronoLocalDate mo16926v(int i10, int i11) {
        return new C15543H(LocalDate.m16798c0(i10 - 543, i11));
    }

    @Override // p817j$.time.chrono.InterfaceC15555k
    /* JADX INFO: renamed from: l */
    public final ChronoLocalDate mo16922l(long j10) {
        return new C15543H(LocalDate.ofEpochDay(j10));
    }

    @Override // p817j$.time.chrono.AbstractC15545a
    /* JADX INFO: renamed from: o */
    public final ChronoLocalDate mo16923o() {
        return new C15543H(LocalDate.m16792R(LocalDate.m16796a0(Clock.systemDefaultZone())));
    }

    @Override // p817j$.time.chrono.InterfaceC15555k
    /* JADX INFO: renamed from: p */
    public final ChronoLocalDate mo16924p(TemporalAccessor temporalAccessor) {
        if (temporalAccessor instanceof C15543H) {
            return (C15543H) temporalAccessor;
        }
        return new C15543H(LocalDate.m16792R(temporalAccessor));
    }

    @Override // p817j$.time.chrono.InterfaceC15555k
    /* JADX INFO: renamed from: M */
    public final boolean mo16919M(long j10) {
        return C15562r.f48594d.mo16919M(j10 - 543);
    }

    @Override // p817j$.time.chrono.InterfaceC15555k
    /* JADX INFO: renamed from: g */
    public final int mo16921g(InterfaceC15556l interfaceC15556l, int i10) {
        if (interfaceC15556l instanceof EnumC15544I) {
            return interfaceC15556l == EnumC15544I.f48555BE ? i10 : 1 - i10;
        }
    ...
    public final List mo16918K() {
        return AbstractC15529a.m16747k(EnumC15544I.values());
    }

    @Override // p817j$.time.chrono.InterfaceC15555k
    /* JADX INFO: renamed from: H */
    public final C15637q mo16916H(EnumC15621a enumC15621a) {
        int i10 = AbstractC15540E.f48551a[enumC15621a.ordinal()];
        if (i10 == 1) {
            C15637q c15637qMo17142m = EnumC15621a.PROLEPTIC_MONTH.mo17142m();
            return C15637q.m17168j(c15637qMo17142m.m17173e() + 6516, c15637qMo17142m.m17172d() + 6516);
        }
        if (i10 == 2) {
            C15637q c15637qMo17142m2 = EnumC15621a.YEAR.mo17142m();
            return C15637q.m17169k(1L, (-(c15637qMo17142m2.m17173e() + 543)) + 1, c15637qMo17142m2.m17172d() + 543);
        }
        if (i10 == 3) {
            C15637q c15637qMo17142m3 = EnumC15621a.YEAR.mo17142m();
            return C15637q.m17168j(c15637qMo17142m3.m17173e() + 543, c15637qMo17142m3.m17172d() + 543);
        }
    ...
    public final ChronoLocalDate mo16915G(Map map, EnumC15578E enumC15578E) {
        return (C15543H) super.mo16915G(map, enumC15578E);
    }
