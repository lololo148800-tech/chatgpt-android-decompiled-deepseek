...
public final /* data */ class QueryPurchaseHistoryUseCaseParams implements UseCaseParams {
    ...
    public static /* synthetic */ QueryPurchaseHistoryUseCaseParams copy$default(QueryPurchaseHistoryUseCaseParams queryPurchaseHistoryUseCaseParams, DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, String str, boolean z6, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC16544l.m18089b(this.dateProvider, queryPurchaseHistoryUseCaseParams.dateProvider) && AbstractC16544l.m18089b(this.diagnosticsTrackerIfEnabled, queryPurchaseHistoryUseCaseParams.diagnosticsTrackerIfEnabled) && AbstractC16544l.m18089b(this.productType, queryPurchaseHistoryUseCaseParams.productType) && this.appInBackground == queryPurchaseHistoryUseCaseParams.appInBackground;
    }
    ...
    public int hashCode() {
        ...
        int iM527p = AbstractC0168G.m527p((iHashCode + (diagnosticsTracker == null ? 0 : diagnosticsTracker.hashCode())) * 31, 31, this.productType);
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("QueryPurchaseHistoryUseCaseParams(dateProvider=");
    ...
    public /* synthetic */ QueryPurchaseHistoryUseCaseParams(DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, String str, boolean z6, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? new DefaultDateProvider() : dateProvider, diagnosticsTracker, str, z6);
    }
}
