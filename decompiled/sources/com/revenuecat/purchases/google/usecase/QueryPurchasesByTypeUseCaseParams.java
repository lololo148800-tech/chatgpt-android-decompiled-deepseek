...
public final /* data */ class QueryPurchasesByTypeUseCaseParams implements UseCaseParams {
    ...
    public QueryPurchasesByTypeUseCaseParams(DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, boolean z6, String productType) {
    ...
    public static /* synthetic */ QueryPurchasesByTypeUseCaseParams copy$default(QueryPurchasesByTypeUseCaseParams queryPurchasesByTypeUseCaseParams, DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, boolean z6, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC16544l.m18089b(this.dateProvider, queryPurchasesByTypeUseCaseParams.dateProvider) && AbstractC16544l.m18089b(this.diagnosticsTrackerIfEnabled, queryPurchasesByTypeUseCaseParams.diagnosticsTrackerIfEnabled) && this.appInBackground == queryPurchasesByTypeUseCaseParams.appInBackground && AbstractC16544l.m18089b(this.productType, queryPurchasesByTypeUseCaseParams.productType);
    }
    ...
    public int hashCode() {
        ...
        return this.productType.hashCode() + ((iHashCode2 + r6) * 31);
    }
    ...
    public String toString() {
        ...
        return AbstractC9306j0.m9892k(sb2, this.productType, ')');
    }

    public /* synthetic */ QueryPurchasesByTypeUseCaseParams(DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, boolean z6, String str, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? new DefaultDateProvider() : dateProvider, diagnosticsTracker, z6, str);
    }
}
