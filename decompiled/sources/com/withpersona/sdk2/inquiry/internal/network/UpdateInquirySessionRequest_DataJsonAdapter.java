...
public final class UpdateInquirySessionRequest_DataJsonAdapter extends AbstractC11471r {

    /* JADX INFO: renamed from: a */
    public final C11475v f40846a;

    /* JADX INFO: renamed from: b */
    public final AbstractC11471r f40847b;

    public UpdateInquirySessionRequest_DataJsonAdapter(C11447L moshi) {
        AbstractC16544l.m18094g(moshi, "moshi");
        this.f40846a = C11475v.m12866a("attributes");
        this.f40847b = moshi.m12850b(UpdateInquirySessionRequest.Attributes.class, C17691y.f56482Y, "attributes");
    }
    ...
    public final Object fromJson(AbstractC11477x reader) {
        ...
        while (reader.hasNext()) {
            int iMo12819v0 = reader.mo12819v0(this.f40846a);
            if (iMo12819v0 == -1) {
                reader.mo12802H0();
                reader.mo12800D();
            } else if (iMo12819v0 == 0 && (attributes = (UpdateInquirySessionRequest.Attributes) this.f40847b.fromJson(reader)) == null) {
    ...
    public final void toJson(AbstractC11440E writer, Object obj) {
        ...
        this.f40847b.toJson(writer, data.f40839a);
        writer.mo12823E();
    }

    public final String toString() {
        return AbstractC20734X.m21255z(54, "GeneratedJsonAdapter(UpdateInquirySessionRequest.Data)", "StringBuilder(capacity).…builderAction).toString()");
    }
}
