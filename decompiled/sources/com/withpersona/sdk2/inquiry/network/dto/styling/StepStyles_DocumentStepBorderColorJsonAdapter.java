...
public final class StepStyles_DocumentStepBorderColorJsonAdapter extends AbstractC11471r {
    ...
    public StepStyles_DocumentStepBorderColorJsonAdapter(C11447L c11447l) {
        this.nullableSimpleElementColorAdapter = c11447l.m12850b(StyleElements.SimpleElementColor.class, C17691y.f56482Y, "imagePreview");
    }

    public String toString() {
        return AbstractC12107L1.m13823n(56, "GeneratedJsonAdapter(StepStyles.DocumentStepBorderColor)");
    }

    @Override // bj.AbstractC11471r
    public StepStyles.DocumentStepBorderColor fromJson(AbstractC11477x reader) {
        reader.mo12814e();
    ...
    @Override // bj.AbstractC11471r
    public void toJson(AbstractC11440E writer, StepStyles.DocumentStepBorderColor value_) {
        if (value_ == null) {
