...
public final class AttributeStyles_ComplexTextBasedTextColorStyleJsonAdapter extends AbstractC11471r {
    ...
    @Override // bj.AbstractC11471r
    public void toJson(AbstractC11440E writer, AttributeStyles.ComplexTextBasedTextColorStyle value_) {
        if (value_ == null) {
        ...
        writer.mo12827T(sRXLFOsOgS.FarVLzIxD);
        this.nullableComplexElementColorAdapter.toJson(writer, value_.getError());
        writer.mo12823E();
    }

    public AttributeStyles_ComplexTextBasedTextColorStyleJsonAdapter(C11447L c11447l) {
        String str = SfpOlmlMATQ.DYLEgDWyrysihh;
        this.options = C11475v.m12866a(str, "placeholder", "label", "error");
        this.nullableComplexElementColorAdapter = c11447l.m12850b(StyleElements.ComplexElementColor.class, C17691y.f56482Y, str);
    }
}
