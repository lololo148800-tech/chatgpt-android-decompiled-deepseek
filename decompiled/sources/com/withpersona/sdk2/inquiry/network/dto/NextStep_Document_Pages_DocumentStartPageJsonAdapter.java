...
public final class NextStep_Document_Pages_DocumentStartPageJsonAdapter extends AbstractC11471r {
    ...
    public NextStep_Document_Pages_DocumentStartPageJsonAdapter(C11447L c11447l) {
        C17691y c17691y = C17691y.f56482Y;
        this.uiAdapter = c11447l.m12850b(NextStep.C12890Ui.class, c17691y, "uiStep");
        this.nullableComponentNameMappingAdapter = c11447l.m12850b(NextStep.Document.Pages.DocumentStartPage.ComponentNameMapping.class, c17691y, "componentNameMapping");
    }

    public String toString() {
        return AbstractC12107L1.m13823n(63, "GeneratedJsonAdapter(NextStep.Document.Pages.DocumentStartPage)");
    }

    @Override // bj.AbstractC11471r
    public NextStep.Document.Pages.DocumentStartPage fromJson(AbstractC11477x reader) {
        reader.mo12814e();
        ...
        reader.mo12818m();
        if (c12890Ui != null) {
            return new NextStep.Document.Pages.DocumentStartPage(c12890Ui, componentNameMapping);
        }
        throw AbstractC13178c.m14832f("uiStep", "uiStep", reader);
    }

    @Override // bj.AbstractC11471r
    public void toJson(AbstractC11440E writer, NextStep.Document.Pages.DocumentStartPage value_) {
        if (value_ == null) {
