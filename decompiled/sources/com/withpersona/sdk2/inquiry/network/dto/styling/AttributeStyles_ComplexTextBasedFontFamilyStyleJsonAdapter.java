...
public final class AttributeStyles_ComplexTextBasedFontFamilyStyleJsonAdapter extends AbstractC11471r {
    ...
    public AttributeStyles_ComplexTextBasedFontFamilyStyleJsonAdapter(C11447L c11447l) {
        this.nullableFontNameAdapter = c11447l.m12850b(StyleElements.FontName.class, C17691y.f56482Y, "base");
    }

    public String toString() {
        return AbstractC12107L1.m13823n(69, "GeneratedJsonAdapter(AttributeStyles.ComplexTextBasedFontFamilyStyle)");
    }

    @Override // bj.AbstractC11471r
    public AttributeStyles.ComplexTextBasedFontFamilyStyle fromJson(AbstractC11477x reader) {
        reader.mo12814e();
    ...
    @Override // bj.AbstractC11471r
    public void toJson(AbstractC11440E writer, AttributeStyles.ComplexTextBasedFontFamilyStyle value_) {
        if (value_ == null) {
        ...
        this.nullableFontNameAdapter.toJson(writer, value_.getValue());
        writer.mo12827T(suYVq.VcsbGXAyXsN);
        this.nullableFontNameAdapter.toJson(writer, value_.getPlaceholder());
