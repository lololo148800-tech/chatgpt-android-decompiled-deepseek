...
public final class UiComponentConfig_InputTextBasedComponentStyleJsonAdapter extends AbstractC11471r {
    ...
    private final AbstractC11471r nullableInputTextStrokeColorStyleAdapter;
    private final C11475v options = C11475v.m12866a("margin", "fontFamily", "fontSize", "fontWeight", "letterSpacing", "lineHeight", "textColor", "borderRadius", "borderWidth", "backgroundColor", "borderColor", "strokeColor");

    public UiComponentConfig_InputTextBasedComponentStyleJsonAdapter(C11447L c11447l) {
        ...
        this.nullableInputTextStrokeColorStyleAdapter = c11447l.m12850b(AttributeStyles.InputTextStrokeColorStyle.class, c17691y, "strokeColor");
    }

    public String toString() {
        return AbstractC12107L1.m13823n(68, "GeneratedJsonAdapter(UiComponentConfig.InputTextBasedComponentStyle)");
    }

    @Override // bj.AbstractC11471r
    public UiComponentConfig.InputTextBasedComponentStyle fromJson(AbstractC11477x reader) {
        reader.mo12814e();
    ...
    public void toJson(AbstractC11440E writer, UiComponentConfig.InputTextBasedComponentStyle value_) {
        ...
        this.nullableInputTextStrokeColorStyleAdapter.toJson(writer, value_.getStrokeColor());
        writer.mo12823E();
    }
}
