...
public final class NextStep_GovernmentId_AssetConfig_SelectPageJsonAdapter extends AbstractC11471r {
    ...
    private final C11475v options = C11475v.m12866a("headerPictograph", "iconDriversLicense", "iconPassport", "iconNationalId", "iconGovernmentId");

    public NextStep_GovernmentId_AssetConfig_SelectPageJsonAdapter(C11447L c11447l) {
        this.nullableRemoteImageAdapter = c11447l.m12850b(UiComponentConfig.RemoteImage.class, C17691y.f56482Y, "headerPictograph");
    }

    public String toString() {
        return AbstractC12107L1.m13823n(66, "GeneratedJsonAdapter(NextStep.GovernmentId.AssetConfig.SelectPage)");
    }

    @Override // bj.AbstractC11471r
    public NextStep.GovernmentId.AssetConfig.SelectPage fromJson(AbstractC11477x reader) throws NoSuchMethodException {
        reader.mo12814e();
        ...
        if (declaredConstructor == null) {
            declaredConstructor = NextStep.GovernmentId.AssetConfig.SelectPage.class.getDeclaredConstructor(UiComponentConfig.RemoteImage.class, UiComponentConfig.RemoteImage.class, UiComponentConfig.RemoteImage.class, UiComponentConfig.RemoteImage.class, UiComponentConfig.RemoteImage.class, Integer.TYPE, AbstractC13178c.f41822c);
    ...
    @Override // bj.AbstractC11471r
    public void toJson(AbstractC11440E writer, NextStep.GovernmentId.AssetConfig.SelectPage value_) {
        if (value_ == null) {
