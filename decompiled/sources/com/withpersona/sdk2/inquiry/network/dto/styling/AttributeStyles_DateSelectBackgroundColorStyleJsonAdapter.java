...
public final class AttributeStyles_DateSelectBackgroundColorStyleJsonAdapter extends AbstractC11471r {
    ...
    private final C11475v options = C11475v.m12866a("base", "inputSelect");

    public AttributeStyles_DateSelectBackgroundColorStyleJsonAdapter(C11447L c11447l) {
    ...
    public String toString() {
        return AbstractC12107L1.m13823n(68, "GeneratedJsonAdapter(AttributeStyles.DateSelectBackgroundColorStyle)");
    }

    @Override // bj.AbstractC11471r
    public AttributeStyles.DateSelectBackgroundColorStyle fromJson(AbstractC11477x reader) {
        reader.mo12814e();
    ...
    @Override // bj.AbstractC11471r
    public void toJson(AbstractC11440E writer, AttributeStyles.DateSelectBackgroundColorStyle value_) {
        if (value_ == null) {
