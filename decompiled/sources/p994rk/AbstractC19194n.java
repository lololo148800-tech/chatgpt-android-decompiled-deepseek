...
public abstract class AbstractC19194n {
    /* JADX INFO: renamed from: a */
    public static final ConstraintLayout m20316a(ClickableStackComponent clickableStackComponent, C5311e c5311e, ArrayList arrayList, List children) {
        ConstraintLayout constraintLayout;
        StyleElements.Axis axisValue;
        StyleElements.DPSize gapValue;
        Double dp2;
        AbstractC16544l.m18094g(clickableStackComponent, "<this>");
        AbstractC16544l.m18094g(children, "children");
        View viewInflate = ((LayoutInflater) c5311e.f17485o0).inflate(R.layout.pi2_ui_clickable_stack, (ViewGroup) null, false);
        ...
        if (((Guideline) AbstractC9123E2.m9654b(viewInflate, R.id.left_guideline)) != null) {
            ...
            if (((Guideline) AbstractC9123E2.m9654b(viewInflate, R.id.right_guideline)) != null) {
                ...
                C20374d c20374d = new C20374d(constraintLayout2, 0);
                ...
                UiComponentConfig.ClickableStackComponentStyle styles = clickableStackComponent.f40897Y.getStyles();
                ...
                if (styles != null) {
                    ((LinkedList) c5311e.f17486p0).add(new C19190m(c20374d, styles));
                }
