...
public final class CredentialProviderBeginSignInController$handleResponse$2 extends AbstractC16546n implements InterfaceC1436k {
    ...
    public final void invoke(final AbstractC2979e e10) {
        ...
        executor.execute(new Runnable() { // from class: androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$handleResponse$2$$ExternalSyntheticLambda0
            ...
            public final void run() {
                CredentialProviderBeginSignInController$handleResponse$2.invoke$lambda$0(credentialProviderBeginSignInController, e10);
            }
        });
    }
}
